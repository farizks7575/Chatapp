...
const app = express();
app.use(cors({ origin: 'https://leafy-lebkuchen-38cd77.netlify.app' }));
...
const io = new Server(server, {
  cors: { origin: 'https://leafy-lebkuchen-38cd77.netlify.app', methods: ['GET', 'POST', 'PUT', 'DELETE'] }, // Added DELETE method for completeness
});
